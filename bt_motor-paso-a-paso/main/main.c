...
static void esp_spp_cb(esp_spp_cb_event_t event, esp_spp_cb_param_t *param)
{
    ...
    case ESP_SPP_DATA_IND_EVT:
        ...
        {
            char value = param->data_ind.data[0];
            printf("%c", value);
        	printf("longitud: %i", param->data_ind.len);
        switch (value)
            {
            case 'D':
                printf("Has elegido el sentido horario:\n");
                desplaza_horario(100);
                break;
            case 'B':
                printf("Has elegido el sentido antihorario.\n");
                desplaza_antihorario(100);
                break;
            default:
                break;
            }
